 ...
 */
package fgarcia.test.protocols.avro;
...
public class Person extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -6333740594199925937L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Person\",\"namespace\":\"fgarcia.test.protocols.avro\",\"fields\":[{\"name\":\"firstName\",\"type\":\"string\"},{\"name\":\"lastName\",\"type\":\"int\"},{\"name\":\"address\",\"type\":\"string\"},{\"name\":\"age\",\"type\":\"int\"},{\"name\":\"moreInfo\",\"type\":{\"type\":\"array\",\"items\":\"string\"}}]}");
   ...
   */
  public static fgarcia.test.protocols.avro.Person.Builder newBuilder() {
    return new fgarcia.test.protocols.avro.Person.Builder();
  }
   ...
   * @return A new Person RecordBuilder
   */
  public static fgarcia.test.protocols.avro.Person.Builder newBuilder(fgarcia.test.protocols.avro.Person.Builder other) {
    return new fgarcia.test.protocols.avro.Person.Builder(other);
  }
   ...
   * @return A new Person RecordBuilder
   */
  public static fgarcia.test.protocols.avro.Person.Builder newBuilder(fgarcia.test.protocols.avro.Person other) {
    return new fgarcia.test.protocols.avro.Person.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Person>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(fgarcia.test.protocols.avro.Person.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(fgarcia.test.protocols.avro.Person other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.firstName)) {
        this.firstName = data().deepCopy(fields()[0].schema(), other.firstName);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public fgarcia.test.protocols.avro.Person.Builder setFirstName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public fgarcia.test.protocols.avro.Person.Builder clearFirstName() {
      firstName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public fgarcia.test.protocols.avro.Person.Builder setLastName(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public fgarcia.test.protocols.avro.Person.Builder clearLastName() {
    ...
    /**
      ...
      * @return This builder.
      */
    public fgarcia.test.protocols.avro.Person.Builder setAddress(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public fgarcia.test.protocols.avro.Person.Builder clearAddress() {
      address = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public fgarcia.test.protocols.avro.Person.Builder setAge(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public fgarcia.test.protocols.avro.Person.Builder clearAge() {
    ...
    /**
      ...
      * @return This builder.
      */
    public fgarcia.test.protocols.avro.Person.Builder setMoreInfo(java.util.List<java.lang.CharSequence> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public fgarcia.test.protocols.avro.Person.Builder clearMoreInfo() {
      moreInfo = null;
